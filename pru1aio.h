...
* Type Declarations                                                           * 
******************************************************************************/
typedef struct s_pru_rta_readings {
...
typedef struct s_pru_rta_condition {
	char name[33];
...
typedef struct s_pru_rta_conditions {
	char number_conditions;
	pru_rta_condition *conditions;
} pru_rta_conditions;

typedef struct s_pru_rta_call_state {
	pru_rta_readings *readings;
	pru_rta_readings *ring_buffer;
	pru_rta_readings *buffer_mean;
	int ring_buffer_size;
	int ring_current_location;
	int records;
	int maximum_records;
	int signals;
	void *caller_state;
...
void pru_rta_start_capture(pru_shared_mem *pru_mem, void (*async_call)(unsigned int buffer_count, unsigned short buffer_size, pru_rta_readings *captured_buffer, pru_rta_call_state* call_state, pru_shared_mem *pru_mem), pru_rta_call_state* call_state);
